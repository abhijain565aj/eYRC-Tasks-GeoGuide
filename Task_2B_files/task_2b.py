...
'''
class_names = ['combat', 'destroyedbuilding',
               'fire', 'humanitarianaid', 'militaryvehicles']
...
def classify_event(image_pth):
    ...
    image = cv2.imread(image_pth)  # Load the image using cv2 (OpenCV)
    ...
    # Assuming class_names is a list of event names
    event = class_names[min(predicted.item(), len(class_names))]
